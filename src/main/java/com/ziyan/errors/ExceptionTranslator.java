...
public class ExceptionTranslator {
    ...
    @ResponseBody
    public ResponseEntity<NestExceptionData> processCustomException(NestException ex) {
        BodyBuilder bodyBuilder = ResponseEntity.status(HttpStatus.EXPECTATION_FAILED);
        return bodyBuilder.body(ex.getData());
    }
